...
/**
 * User: duxing Date: 2015.08.12 1:31
 */
public class SettingManager {
  ...
  public static void applySwitch(Boolean managerUseBO, Boolean daoLogicDelete, Boolean daoUseSequence, Boolean pagerQuery,
      Boolean overwrite, Boolean generateBase) {
    PluginProjectConfig pluginProjectConfig = PluginProjectConfigHolder.getPluginProjectConfig();
    if (pluginProjectConfig != null) {
