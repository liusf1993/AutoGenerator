...
/**
 * User: duxing Date: 2015.08.12 2:28
 */
public class Setting {
  ...
  public void setSwitch(Boolean managerUseBO, Boolean daoLogicDelete, Boolean daoUseSequence, Boolean pagerQuery, Boolean overwrite,
      Boolean generateBase) {
