...
/**
 * User: duxing Date: 2015.08.14 0:17
 */
public class GeneratorAdaptor {
  ...
  public boolean generateDO() {
    ...
    String s = generator.generateDO(tableName, name, getDoColumnList());
  ...
  public boolean generateDAOImpl() {
    ...
    String s = generator
        .generateDAOImpl(name(GenerateType.DO), name(GenerateType.Query), name(GenerateType.DAO), name, primaryColumn, tableName);
    return FileWriter.write(path, addExt(name), r(s));
  }
  ...
  public boolean generateManager() {
    ...
    String s = generator
        .generateManager(setting.isManagerUseBO() ? name(GenerateType.BO) : name(GenerateType.DO), name(GenerateType.Query), name,
            primaryColumn);
    return FileWriter.write(path, addExt(name), r(s));
  }
  ...
  public boolean generateManagerImpl() {
    ...
    String s = generator
        .generateManagerImpl(name(GenerateType.DO), name(GenerateType.BO), name(GenerateType.Query), name(GenerateType.Transfer),
  ...
  public boolean generateSqlmap() {
    ...
    String s = generator
        .generateSqlmap(tableName, primaryColumn, name(GenerateType.DO), name(GenerateType.DAO), doColumnList, queryColumnList);
